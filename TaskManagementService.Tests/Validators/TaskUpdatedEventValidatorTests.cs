...
{
    public class TaskUpdatedEventValidatorTests
    {
        private readonly TaskUpdatedEventValidator _validator;

        public TaskUpdatedEventValidatorTests()
        {
            _validator = new TaskUpdatedEventValidator();
        }

        [Fact]
        public void Should_Have_Error_When_EventId_Is_Empty()
        {
            var validEvent = new TaskUpdatedEvent(Guid.NewGuid(), "Valid Title", "Valid Description", TaskState.New);
        ...
        {
            var model = new TaskUpdatedEvent(Guid.Empty, "Valid Title", "Valid Description", TaskState.New);
            var result = _validator.TestValidate(model);
        ...
        {
            var model = new TaskUpdatedEvent(Guid.NewGuid(), string.Empty, "Valid Description", TaskState.New);
            var result = _validator.TestValidate(model);
            result.ShouldHaveValidationErrorFor(x => x.Title)
                  .WithErrorMessage("Название задачи обязательно.");
        ...
        {
            var model = new TaskUpdatedEvent(Guid.NewGuid(), new string('A', 201), "Valid Description", TaskState.New);
            var result = _validator.TestValidate(model);
            result.ShouldHaveValidationErrorFor(x => x.Title)
        ...
        {
            var model = new TaskUpdatedEvent(Guid.NewGuid(), "Valid Title", new string('A', 2001), TaskState.New);
            var result = _validator.TestValidate(model);
        ...
        {
            var model = new TaskUpdatedEvent(Guid.NewGuid(), "Valid Title", "Valid Description", TaskState.New);
            var result = _validator.TestValidate(model);
        ...
        {
            var model = new TaskUpdatedEvent(Guid.NewGuid(), "Valid Title", "Valid Description", TaskState.InProgress);
            var result = _validator.TestValidate(model);
            result.ShouldNotHaveAnyValidationErrors();
        }
        ...
        {
            var model = new TaskUpdatedEvent(Guid.NewGuid(), "Valid Title", "Valid Description", TaskState.Completed);
            var result = _validator.TestValidate(model);
            result.ShouldNotHaveAnyValidationErrors();
        }
        ...
        {
            var model = new TaskUpdatedEvent(Guid.NewGuid(), new string('A', 200), "Valid Description", TaskState.New);
            var result = _validator.TestValidate(model);
        ...
        {
            var model = new TaskUpdatedEvent(Guid.NewGuid(), "Valid Title", new string('A', 2000), TaskState.New);
            var result = _validator.TestValidate(model);
